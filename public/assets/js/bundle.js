...
var CPF = /*#__PURE__*/function () {
  ...
  _createClass(CPF, [{
    ...
    value: function verificaSequencia() {
      var limpaCpf = this.cpf.replace(/\D+/g, '');
      return limpaCpf.charAt(0).repeat(limpaCpf.length) === limpaCpf;
    }
  }, {
    key: "verificaValidade",
    value: function verificaValidade() {
      ...
      var primeiroDigito = String(this.retornaDigito(cpf.slice(0, cpf.length - 2)));
      var segundoDigito = String(this.retornaDigito(cpf.slice(0, cpf.length - 1)));
    ...
    key: "retornaDigito",
    value: function retornaDigito(valor) {
      var valorCPF = Array.from(valor);
      var filterValorCPF = valorCPF.filter(function (elemento) {
        return elemento !== '.' && elemento !== '-';
      });
      if (filterValorCPF.length == 9) valorCPF.splice(-2, 2);
      if (filterValorCPF.length == 10) valorCPF.splice(-1, 1);
      var regresso = filterValorCPF.length + 1;
      var somaDosElementos = filterValorCPF.reduce(function (ac, val) {
        ac += regresso * Number(val);
        regresso--;
        return ac;
      }, 0);
      var resultado = 11 - somaDosElementos % 11;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CPF);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n* ::-webkit-scrollbar {\n  width: 0.4rem;\n}\n* ::-webkit-scrollbar-track {\n  background: #f1f1f1;\n}\n* ::-webkit-scrollbar-thumb {\n  background: #0c5858;\n}\n* ::-webkit-scrollbar-thumb:hover {\n  background: #555;\n}\n\nbody {\n  background-color: #0c5858;\n  color: #0c5858;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  font-size: 1.2rem;\n}\nbody h1 {\n  color: #FFFFFF;\n  margin-top: 1.5rem;\n}\nbody section {\n  width: 400px;\n  padding: 10px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-top: 1.5rem;\n  background-color: #FFFFFF;\n  border-radius: 5px;\n}\nbody section h2 {\n  margin-bottom: 1rem;\n}\nbody section .gerar {\n  width: 170px;\n  height: 30px;\n  border-radius: 5px;\n}\nbody section .gerar:hover {\n  background-color: #1b7777;\n  color: #FFFFFF;\n}\nbody section .gerar:active {\n  background-color: #0c5858;\n}\nbody section .cpf-gerado {\n  border: #0c5858 1px solid;\n  margin-top: 1.5rem;\n  margin-bottom: 1.5rem;\n  width: 250px;\n  min-height: 35px;\n  padding: 5px;\n  display: flex;\n  justify-content: center;\n}\nbody section .historico {\n  height: 200px;\n  width: 200px;\n  overflow-y: scroll;\n}\n\n/*# sourceMappingURL=styles.css.map */\n", "",{"version":3,"sources":["webpack://./src/assets/css/index.scss","webpack://./src/assets/css/styles.css"],"names":[],"mappings":"AAAA;EACI,UAAA;EACA,SAAA;EACA,sBAAA;ACCJ;ADAI;EACI,aAAA;ACER;ADAI;EACI,mBAAA;ACER;ADAI;EACI,mBAAA;ACER;ADAI;EACI,gBAAA;ACER;;ADEA;EACI,yBAAA;EACA,cAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,iBAAA;ACCJ;ADCI;EACI,cAAA;EACA,kBAAA;ACCR;ADEI;EACI,YAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,kBAAA;EACA,yBAAA;EACA,kBAAA;ACAR;ADEQ;EACI,mBAAA;ACAZ;ADGQ;EACI,YAAA;EACA,YAAA;EACA,kBAAA;ACDZ;ADGY;EACI,yBAAA;EACA,cAAA;ACDhB;ADIY;EACI,yBAAA;ACFhB;ADOQ;EACI,yBAAA;EACA,kBAAA;EACA,qBAAA;EACA,YAAA;EACA,gBAAA;EACA,YAAA;EACA,aAAA;EACA,uBAAA;ACLZ;ADQQ;EACI,aAAA;EACA,YAAA;EACA,kBAAA;ACNZ;;AAEA,qCAAqC","sourceRoot":""}]);
// Exports
